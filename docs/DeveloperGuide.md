...
The target user of this application is anyone who wants to play chess on their computer. The user should have a basic understanding of chess, and can learn how to play it and what moves are valid through the application. This can help hone the ability of the user to play chess. It is also on a command line interface as chess applications can be bloated, and a command line interface is more lightweight and easier to use on different devices. As a result, advanced moves such as en passant is not implemented as it can be confusing to new users.

### Value proposition

Learning chess can be difficult, and it is hard to find a chess application that is not bloated with features. This application aims to provide a simple chess application that is easy to use and lightweight. It also aims to provide a simple way to play chess against a computer, which can be difficult to find in other chess applications.
...
|v2.0|player|play against the computer|learn from moves generated by someone else|
|v2.0|player|see the computer's moves|know what the computer is doing|
|v2.0|player|see my moves|know what I am doing|
|v2.0|player|see what moves I can make|know what I can do|
|v2.0|player|adjust the difficulty of the computer|play against a computer that is at my level|
